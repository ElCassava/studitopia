...
-- Modified to use ONLY auditory learning style
...
-- Note: Take the course ID from the above query and replace it in the following sections
-- For this example, I'll use a placeholder: COURSE_ID_HERE

-- 2. Create course sections (learn, test, quiz)
-- Learn Section
INSERT INTO public.course_sections (course_id, section_type) 
VALUES ('COURSE_ID_HERE', 'learn') RETURNING id;

-- Test Section  
INSERT INTO public.course_sections (course_id, section_type) 
VALUES ('COURSE_ID_HERE', 'test') RETURNING id;

-- Quiz Section (empty for now as requested)
INSERT INTO public.course_sections (course_id, section_type) 
VALUES ('COURSE_ID_HERE', 'quiz') RETURNING id;

-- 3. Create learn section with AUDITORY learning style
...
VALUES ('LEARN_COURSE_SECTION_ID', '9bdc1a7d-9ce1-49a6-afc6-96448f0c7f85') RETURNING id;

-- 4. Create 3 learn contents (optimized for auditory learners)
...
-- 5. Create test section with AUDITORY learning style
...
VALUES ('TEST_COURSE_SECTION_ID', '9bdc1a7d-9ce1-49a6-afc6-96448f0c7f85') RETURNING id;

-- 6. Create test questions and choices (all 14 questions)
...
-- 7. Create quiz section with AUDITORY learning style (empty as requested)
...
VALUES ('QUIZ_COURSE_SECTION_ID', '9bdc1a7d-9ce1-49a6-afc6-96448f0c7f85') RETURNING id;
...
-- 
-- IMPORTANT NOTES:
-- 1. This script uses ONLY the auditory learning style ID: 9bdc1a7d-9ce1-49a6-afc6-96448f0c7f85
-- 2. Learning content has been optimized for auditory learners (focus on listening, pronunciation, verbal patterns)
-- 3. You need to replace placeholder IDs step by step as you execute the script
-- 4. The quiz section is created but left empty as requested
-- 5. All 14 test questions are included with their complete choice sets
